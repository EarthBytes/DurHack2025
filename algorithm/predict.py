...
class PokemonBattlePredictor:
    ...
    def get_type_advantage(self, attacker_type1, attacker_type2, defender_type1, defender_type2):
        # Calculate type advantage score. Returns -1, 0 or 1
        total = 0
        
        # Check attacker type1 against both defender types
        ...
        # Check attacker type2 (if exists) against both defender types
        if attacker_type2:
    ...
    def predict(self, pokemon1, pokemon2, weather='Clear', status_p1='None', 
        ...
        Args:
            pokemon1: Name of first Pokemon (lowercase)
            pokemon2: Name of second Pokemon (lowercase)
            weather: Sun, Rain, Sandstorm, Hail, or Clear
            status_p1: Burn, Paralysis, or None
            status_p2: Burn, Paralysis, or None
            terrain: Electric, Grassy, Misty, Psychic, or None
            hazards: Stealth Rock, Spikes, Toxic Spikes, or None
        ...
        for feature in ['weather', 'status_p1', 'status_p2', 'terrain', 'hazards']:
            ...
            if features[feature] in le.classes_:
                ...
                feature_df[feature] = 0  # Default to first class
